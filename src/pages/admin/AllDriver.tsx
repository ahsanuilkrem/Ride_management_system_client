...
import { AVAILABILITY, IsStatus, VEHICLE_TYPE, type Availability,  type DriverStatus,  type IDriver } from "@/types/driver.type";
import { useGetDriverQuery, useUpdateDriverStatusMutation } from "@/redux/features/driver/driver.api";
...
// console.log("driver", driversResponse)
  ...
  // const rawDrivers = (driversResponse ?? null) as unknown;
  ...
  if (
    ...
    return ((rawDrivers as { data?: Driver[] }).data as Driver[]) ?? [];
  }
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent>
                  ...
                  {Object.entries(IsStatus).map(([key, value]) => (
