...
import { useGetDashboardStatsQuery, useGetDriverStatsQuery, useGetRevenueStatsQuery, useGetRideStatsQuery, useGetUserStatsQuery } from "@/redux/features/admin/stats.api";
...
export default function Analytics() {
  ...
  const { data: dashboard, isLoading: isDashboardLoading } = useGetDashboardStatsQuery();
  ...
  const { data: drivers, isLoading: isDriversLoading } = useGetDriverStatsQuery();
