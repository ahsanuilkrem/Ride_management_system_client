...
import type { IDriverRideHistoryQuery } from "@/types/driver.type";
...
const isPopulatedRide = (
  ...
  return typeof ride.userId === "object" && ride.userId !== null;
};
            ...
            <div className="space-y-2">
              ...
              {ride.rideTimestamps.requestedAt && (
                <div className="flex justify-between text-xs">
                  ...
                  <span>
                    {format(
                      new Date(ride.rideTimestamps.requestedAt),
                      "MMM dd, HH:mm"
                    )}
                  </span>
                </div>
              ...
              {ride.rideTimestamps.acceptedAt && (
                <div className="flex justify-between text-xs">
                  ...
                  <span>
                    {format(
                      new Date(ride.rideTimestamps.acceptedAt),
                      "MMM dd, HH:mm"
                    )}
                  </span>
                </div>
              ...
              {ride.rideTimestamps.pickedUpAt && (
                <div className="flex justify-between text-xs">
                  ...
                  <span>
                    {format(
                      new Date(ride.rideTimestamps.pickedUpAt),
                      "MMM dd, HH:mm"
                    )}
                  </span>
                </div>
              ...
              {ride.rideTimestamps.completedAt && (
                <div className="flex justify-between text-xs">
                  ...
                  <span>
                    {format(
                      new Date(ride.rideTimestamps.completedAt),
                      "MMM dd, HH:mm"
                    )}
                  </span>
                </div>
